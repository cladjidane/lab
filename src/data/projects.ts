...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "Jaja",
    descriptionFr:
      "Un assistant vocal qui agit au lieu de répondre. On parle normalement, plusieurs IA exécutent des tâches en parallèle en arrière-plan, et rendent compte à la fin.",
    about:
  ...
  },
  {
    ...
    name: "Uptake",
    descriptionFr:
      "Apprendre l'anglais sur les articles qu'on lit vraiment. On colle un lien, l'app le transforme en session sur mesure : lecture, écriture, vocabulaire, grammaire.",
    about:
  ...
  },
  {
    ...
    name: "Karousel",
    descriptionFr:
      "Demander à l'IA de produire une maquette propre, à tous les coups. Un traducteur fiable entre ce que l'IA sait décrire et ce qui doit vraiment s'afficher à l'écran.",
    about:
  ...
  },
  {
    ...
    about:
      "Montrer du code dans une présentation, c'est soit une capture illisible, soit un copier-coller qui tue la mise en forme. **Code Spotlight résout le problème** avec des spotlights animés : la zone qu'on veut montrer s'allume, le reste reste contextuel.\n\n## Le format\n\nChaque spotlight est un segment de code plus une annotation. Plusieurs spotlights forment un snippet, qui se partage par URL. L'export en image haute définition permet de coller le résultat dans une slide PowerPoint ou un article Medium sans perte.\n\n## Les deux modes de partage\n\nPar URL du **spotlight** lui-même (pour montrer un point précis), ou par URL du **snippet** complet (pour laisser naviguer entre les spotlights). Le choix change selon qu'on veut pointer ou raconter.\n\n## Le contexte\n\nConstruit pour les conférences et les articles. Chaque talk sur l'IA appliquée demande des passages de code qui ne peuvent pas rester des captures brutes.",
